...
// Windows_win32_x64_StoryGrind_v7.0.0_August_5_2025.zip
...
// create-dmg --volname "StoryGrind" --window-size 600 400 --icon-size 100 --icon "StoryGrind.app" 175 200 --app-drop-link 425 200 "Apple_Silicon_arm64_StoryGrind_v7.0.0_August_5_2025.dmg" "out/StoryGrind-darwin-arm64/StoryGrind.app"
...
const opts = {
  ...
  // create-dmg --volname "StoryGrind" --window-size 600 400 --icon-size 100 --icon "StoryGrind.app" 175 200 --app-drop-link 425 200 "Apple_Intel_x64_StoryGrind_v7.0.0_August_5_2025.dmg" "out/StoryGrind-darwin-x64/StoryGrind.app"
