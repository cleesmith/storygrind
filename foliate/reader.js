...
class Reader {
    ...
    constructor() {
        ...
        const savedTheme = localStorage.getItem('foliate-theme') || 'dark'
    ...
    async open(file) {
        ...
        this.view.renderer?.setAttribute('flow', 'scrolled') // Set default to scrolled
    ...
    setTheme(theme) {
        // Save preference
        localStorage.setItem('foliate-theme', theme)
        
        // Apply theme via CSS classes
...
// Upload interface removed - auto-load Liz.epub
// const dropTarget = $('#drop-target')
...
else open('Liz.epub').catch(e => console.error(e)) // Auto-load Liz.epub